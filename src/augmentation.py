...
def flip(image: Image.Image, horizontal: bool = True, vertical: bool = False) -> Image.Image:
    if horizontal:
...
def crop(image: Image.Image, crop_size: tuple, offset: tuple = (0, 0)) -> Image.Image:
    width, height = image.size
...
def add_gaussian_noise(image: Image.Image, mean: float = 0, stddev: float = 10, seed=0) -> Image.Image:
