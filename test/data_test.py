from src.data import get_samples, get_data_split

FILE_DIR = "/mnt/storage1/shared_data/plant_clef_2025/data/plant_clef_2024_train_281gb/all/"
...
def test_data_split_size() -> None:
    ...
    assert len(train_indices) + len(val_indices) + len(test_indices) == total_samples, "Split sizes do not sum to total samples"
